...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800 space-y-6">
      ...
      <p className="mb-6">Last updated: March 26, 2025</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to navikonline.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to navikonline, accessible from{' '}
          <a
      ...
      {/* Continue rendering the rest of the policy here following the same pattern */}
      ...
      {/* <div class="max-w-4xl mx-auto p-6 text-gray-800 space-y-6"> */}
      <p>
        For more information about the cookies we use and your choices regarding cookies, please visit our
        <a href="#" class="text-blue-600 underline hover:text-blue-800">Cookies Policy</a> or the Cookies section of our
      ...
      <h2 class="text-2xl font-bold mt-8">Children's Privacy</h2>
      ...
      <h2 class="text-2xl font-bold mt-8">Links to Other Websites</h2>
      ...
      <h2 class="text-2xl font-bold mt-8">Changes to this Privacy Policy</h2>
      ...
      <ul class="list-disc pl-6">
        <li>Email: <a href="mailto:info@navikonline.in" class="text-blue-600 underline">info@navikonline.in</a></li>
        <li>Phone: <a href="tel:9100529687" class="text-blue-600 underline">9100529687</a></li>
      </ul>


      {/* </div> */}
      {/* Use headings with mt-x and mb-x classes, paragraphs with mb-x, and lists with list-disc or list-decimal */}
      {/* Each section of the policy should be translated into JSX using Tailwind utility classes */}
